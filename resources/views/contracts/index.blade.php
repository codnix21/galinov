        ...
        <div>
            ...
            @if(Auth::user()->isClient())
                <p class="text-sm text-gray-500 mt-1">
                    Новая сделка — через «Купить онлайн» или «Экспресс-сделка» на странице объявления. Здесь только ваши договоры.
                </p>
            @else
                <p class="text-sm text-gray-500 mt-1">Для аренды после согласования распечатайте бланк на странице договора и прикрепите скан с подписями.</p>
            @endif
        </div>
