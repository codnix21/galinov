...
<div class="max-w-5xl mx-auto">
    ...
    <section class="card p-6 bg-slate-50">
        ...
        <p class="text-sm text-gray-700">Автозаполнение договоров, проверка документов (демо-реестр), тестовый платёж, DaData, карты, Telegram, расписание напоминаний — всё связано в один поток без дублирования данных.</p>
        @auth
