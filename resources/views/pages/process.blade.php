...
<div class="max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <section class="card p-6">
            ...
            <ul class="text-sm space-y-1 text-gray-700">
                ...
                <li>Telegram, напоминания, рабочее место</li>
            </ul>
        </section>
        <section class="card p-6">
    ...
    <section class="card p-6 bg-slate-50">
        ...
        <p class="text-sm text-gray-700">Автозаполнение договоров, проверка документов через реестр, тестовый платёж, DaData, карты, Telegram, расписание напоминаний — всё связано в один поток без дублирования данных.</p>
        @auth
